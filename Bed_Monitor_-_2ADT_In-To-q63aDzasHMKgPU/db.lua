...
function bedmonitor.db.init()
   ...
   if #Result == 0 then
      Connection:execute{sql="CREATE TABLE bed (bed_name TEXT(255) NOT NULL ,ward TEXT(255),patient_first_name TEXT(255),patient_last_name TEXT(255),condition TEXT(255),PRIMARY KEY (bed_name));", live=true}
   end
   Connection:close()
end